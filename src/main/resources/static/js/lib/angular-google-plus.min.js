...
angular.module("googleplus", [])
    .provider("GooglePlus", [function () {
        ...
        a.clientId = null, this.setClientId = function (b) {
            ...
            return a.apiKey
        }, a.scopes = "https://www.googleapis.com/auth/plus.login https://www.googleapis.com/auth/userinfo.email", this.setScopes = function (b) {
            ...
            return f.prototype.login = function () {
                e = b.defer();
                var c = {client_id: a.clientId, scope: a.scopes, immediate: !1};
                ...
                gapi.auth.authorize({client_id: a.clientId, scope: a.scopes, immediate: !0}, this.handleAuthResult)
